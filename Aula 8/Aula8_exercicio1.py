...
def filtrar_registros_por_valor(registros, valor_minimo):
    #Filtra e retorna os registros cuja transação possui um valor maior ou igual a ‘valor_minimo’.
...
def inserir_registro(registros, novo_registro, posicao=None):
    """
    insere um novo registro na lista de registros. se a posição não for invalida,
    o registro é adicionado ao final da lista
    """
...
def remover_registros_antigos(registros, tempo_limite):
    """
    remove da lista de registros aquleles cujo timestamp é inferior a o tempo_limite 
    """
